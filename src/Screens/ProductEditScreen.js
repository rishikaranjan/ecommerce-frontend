...
export const ProductEditScreen = () => {
    ...
    const updateHandler = async (e) => {
        ...
        try {
            ...
            await axios.put(
                `https://ecommerce-myntra-clone.onrender.com/api/products/${productId}`,
                {
                    _id: productId,
                    name,
                    slug,
    ...
    const uploadFileHandler = async (e) => {
        ...
        try {
            ...
            const {data} = await axios.post(
                'https://ecommerce-myntra-clone.onrender.com/api/upload',
                bodyFormData,
                {
                    headers: {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            ...
            try {
                ...
                const {data} = await axios.get(`https://ecommerce-myntra-clone.onrender.com/api/products/${productId}`);
