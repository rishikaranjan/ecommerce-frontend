    ...
    function createOrder(data, actions) {
        ...
        return actions.order.capture().then(async function (details) {
          ...
          try {
            ...
            const { data } = await axios.put(
              ...
              `https://ecommerce-myntra-clone.onrender.com/api/orders/${order._id}/pay`,
      ...
      const deliverOrderHandler = async () => {
        ...
        try {
            ...
            const {data} = await axios.put(
                `https://ecommerce-myntra-clone.onrender.com/api/orders/${order._id}/deliver`,
                {},
                {
                    headers: {authorization: `Bearer ${userInfo.token}`}
                }
    ...
    useEffect(() => {
        ...
        const fetchOrder = async () => {
            ...
            try {
                ...
                const {data} = await axios.get(`https://ecommerce-myntra-clone.onrender.com/api/orders/${orderId}`, {
        ...
        if (!order._id || successPay || successDeliver || (order._id && order._id !== orderId)) {
            ...
            const loadPaypalScript = async () => {
                ...
                const { data: clientId } = await axios.get('https://ecommerce-myntra-clone.onrender.com/api/keys/paypal', {
