...
export const ProductListScreen = () => {
    ...
    const createHandler = async () => {
        ...
        try {
            ...
            const {data} = await axios.post(
                'https://ecommerce-myntra-clone.onrender.com/api/products',
                {},
                {
    ...
    const deleteHandler = async (product) => {
        ...
        try {
            ...
            const {data} = await axios.delete(`https://ecommerce-myntra-clone.onrender.com/api/products/${product._id}`,
                {
                    headers: {authorization: `Bearer ${userInfo.token}`}
                }
            );
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            ...
            try {
                ...
                const {data} = await axios.get(`https://ecommerce-myntra-clone.onrender.com/api/products/admin?page=${page}`, {
