...
export const UserListScreen = () => {
    ...
    const deleteHandler = async (user) => {
        ...
        try {
            ...
            const {data} = await axios.delete(`https://ecommerce-myntra-clone.onrender.com/api/users/${user._id}`,
                {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            ...
            try {
                ...
                const {data} = await axios.get('https://ecommerce-myntra-clone.onrender.com/api/users', {
                    headers: {authorization: `Bearer ${userInfo.token}`}
                })
